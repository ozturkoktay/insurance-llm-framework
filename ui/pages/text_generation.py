    ...
    with tabs[2]:
        ...
        if st.button("Generate Text", type="primary", use_container_width=True):
            with st.spinner("Generating text..."):
                ...
                # Simulate model inference with streaming
                task_type = template.get("task_type", "").lower()

                # Determine which sample text to use based on template type
                ...
                # Simulate streaming by splitting the text into words and displaying them one by one
                ...
                for i, word in enumerate(words):
                    ...
                    # Simulate typing speed (faster than real models for demo purposes)
                    time.sleep(0.05)
